...
export const VideosApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        videos: async (options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const VideosApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async videos(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<DownloadedVideo>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.videos(options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const VideosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        videos(options?: RawAxiosRequestConfig): AxiosPromise<Array<DownloadedVideo>> {
            return localVarFp.videos(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class VideosApi extends BaseAPI {
     ...
     * @memberof VideosApi
     */
    public videos(options?: RawAxiosRequestConfig) {
        return VideosApiFp(this.configuration).videos(options).then((request) => request(this.axios, this.basePath));
    }
}
